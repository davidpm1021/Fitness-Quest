...
export default function WhatsNewModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
      <PixelPanel variant="dialog" className="max-w-2xl w-full max-h-[80vh] overflow-hidden flex flex-col">
        {/* Header */}
        <div className="mb-6 text-center border-b-2 border-purple-500/30 pb-4">
        ...
        {/* Footer Buttons */}
        <div className="flex gap-3 border-t-2 border-purple-500/30 pt-4">
          <PixelButton
            variant="secondary"
            onClick={onClose}
            disabled={isMarking}
